...
public class ElementDraw : MonoBehaviour
{
    [SerializeField] private DrawGame drawGame;
    ...
    public void LastPoint()
    {
        ...
        {
            AudioManager.audioManager.PlayAudio(AudioManager.audioManager.correctSFX, AudioManager.audioManager.effectsAS);
            //drawGame.correct.Play();
